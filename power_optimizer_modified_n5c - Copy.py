...
class PowerOptimizer:
    ...
    def optimize_power_allocation_cost(self):
        ...
        self.apply_load_sharing(available_sources, redundancy_level=0, use_effective=False)
    ...
    def optimize_power_allocation_reliability(self):
        ...
        self.apply_load_sharing(available_sources, redundancy_level=self.redundancy_level, use_effective=True)
    ...
    def apply_load_sharing(self, sources, redundancy_level=0, use_effective=False):
